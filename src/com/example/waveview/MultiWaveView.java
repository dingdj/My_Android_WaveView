...
public class MultiWaveView extends View {
    ...
    public MultiWaveView(Context context, AttributeSet attrs) {
       ...
       /* mOuterRadius = a.getDimension(R.styleable.MultiWaveView_outerRadius, mOuterRadius);
        ...
        mOuterRadius = a.getDimension(R.styleable.waveview_outerRadius, mOuterRadius);
        mHorizontalOffset = a.getDimension(R.styleable.waveview_horizontalOffset,
                mHorizontalOffset);
        mVerticalOffset = a.getDimension(R.styleable.waveview_verticalOffset,
                mVerticalOffset);
        mHitRadius = a.getDimension(R.styleable.waveview_hitRadius, mHitRadius);
        mSnapMargin = a.getDimension(R.styleable.waveview_snapMargin, mSnapMargin);
        mVibrationDuration = a.getInt(R.styleable.waveview_vibrationDuration,
                mVibrationDuration);
        mFeedbackCount = a.getInt(R.styleable.waveview_feedbackCount,
                mFeedbackCount);
        mHandleDrawable = new TargetDrawable(res,
                a.getDrawable(R.styleable.waveview_handleDrawable));
        mTapRadius = mHandleDrawable.getWidth()/2;
        mOuterRing = new TargetDrawable(res, a.getDrawable(R.styleable.waveview_waveDrawable));

        // Read chevron animation drawables
        final int chevrons[] = { R.styleable.waveview_leftChevronDrawable,
                R.styleable.waveview_rightChevronDrawable,
                R.styleable.waveview_topChevronDrawable,
                R.styleable.waveview_bottomChevronDrawable
        };
        ...
        if (a.getValue(R.styleable.waveview_targetDrawables, outValue)) {
        ...
        if (a.getValue(R.styleable.waveview_targetDescriptions, outValue)) {
        ...
        if (a.getValue(R.styleable.waveview_directionDescriptions, outValue)) {
            final int resourceId = outValue.resourceId;
            if (resourceId == 0) {
